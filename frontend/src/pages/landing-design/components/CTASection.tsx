      ...
      <div ref={ref} className="max-w-4xl mx-auto px-6 w-full text-center">
        ...
        <div style={{ opacity: visible ? 1 : 0, transform: visible ? "none" : "translateY(32px)", transition: "all 0.7s ease" }}>
          ...
          <h2 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "clamp(2.4rem,6vw,5rem)", lineHeight: 1.04, letterSpacing: "-0.04em", marginBottom: "1.5rem" }}>
            <span style={{ color: "#e2e8f0" }}>Таны дараагийн чадвар</span>
            <br />
          ...
          <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 400, color: "#64748b", fontSize: "1.1rem", lineHeight: 1.75, maxWidth: "520px", margin: "0 auto 3rem" }}>
            Өөрийн түвшинд тохирсон хичээл, дадлага, AI туслах болон ахицын хяналтаар илүү үр дүнтэй суралцаарай.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <Link
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 0 72px rgba(94,234,212,0.3)"; (e.currentTarget as HTMLAnchorElement).style.transform = "translateY(-2px)"; }}
              onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 0 48px rgba(94,234,212,0.18)"; (e.currentTarget as HTMLAnchorElement).style.transform = "none"; }}>
              Бүртгүүлээд эхлэх <ArrowRight size={18} />
            </Link>
            <button
          ...
          <p style={{ fontFamily: "'DM Mono', monospace", color: "#475569", fontSize: "0.68rem", letterSpacing: "0.06em" }}>
            ҮНЭГҮЙ ЭХЛЭХ БОЛОМЖТОЙ · АХИЦАА ХЯНАХ САМБАРТАЙ
          </p>
        </div>
