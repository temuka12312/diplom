...
const instructors = [
  { name: "А. Сара", role: "Frontend хөгжүүлэгч", tag: "Web Dev", color: "#5eead4", rating: 4.9, students: "18.4k", courses: 6, img: "https://images.unsplash.com/photo-1619852182277-79aa23f82c8e?w=400&h=400&fit=crop&auto=format" },
  { name: "Б. Маркус", role: "Өгөгдлийн шинжээч", tag: "Data Science", color: "#818cf8", rating: 4.8, students: "24.1k", courses: 4, img: "https://images.unsplash.com/photo-1597933471507-1ca5765185d8?w=400&h=400&fit=crop&auto=format" },
  { name: "П. Нара", role: "UX/UI дизайнер", tag: "UX Design", color: "#c084fc", rating: 4.9, students: "11.7k", courses: 5, img: "https://images.unsplash.com/photo-1623076189461-f7706b741c04?w=400&h=400&fit=crop&auto=format" },
  { name: "Д. Амар", role: "AI судлаач", tag: "AI & ML", color: "#34d399", rating: 4.7, students: "9.3k", courses: 3, img: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=400&h=400&fit=crop&auto=format" },
];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12"
          ...
          <div>
            ...
            <h2 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "clamp(1.9rem,3.5vw,3rem)", color: "#e2e8f0", letterSpacing: "-0.03em" }}>
              Туршлагатай багш нараас суралц
            </h2>
          </div>
          <a href="#" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600, color: "#5eead4", textDecoration: "none", fontSize: "0.9rem" }}>Бүх багшийг харах →</a>
        </div>
            ...
            <div key={inst.name}
              ...
              <div className="p-5">
                ...
                <div className="flex items-center gap-1 mb-3">
                  ...
                  <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.68rem", color: "#475569", marginLeft: "2px" }}>үнэлгээ</span>
                </div>
                ...
                <div className="flex justify-between pt-3" style={{ borderTop: "1px solid rgba(94,234,212,0.06)" }}>
                  ...
                  <span style={{ fontFamily: "'DM Mono', monospace", color: "#64748b", fontSize: "0.68rem" }}>{inst.courses} хичээл</span>
                </div>
              </div>
            </div>
          ))}
