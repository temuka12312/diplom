...
const stats = [
  { label: "Идэвхтэй суралцагч", target: 2400, suffix: "+", ring: 82, color: "#5eead4", desc: "Тогтмол суралцдаг хэрэглэгчид" },
  { label: "Сургалтын хичээл",  target: 120, suffix: "+",  ring: 91, color: "#818cf8", desc: "HTML, CSS, JS, AI чиглэлээр" },
  { label: "Дадлага ажил", target: 620,  suffix: "+",  ring: 68, color: "#c084fc", desc: "Шаталсан практик даалгавар" },
  { label: "Дуусгалтын хувь", target: 94,   suffix: "%",  ring: 94, color: "#34d399", desc: "Ахицтай суралцалтын үзүүлэлт" },
];
