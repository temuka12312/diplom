...
const ROLES = ["Developers", "Designers", "Data Scientists", "AI Engineers", "Creators"];
          ...
          <div>
            ...
            <div style={style(0.2)}>
              <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 400, fontSize: "1.05rem", color: "#64748b", lineHeight: 1.8, maxWidth: "460px", marginBottom: "2.5rem" }}>
                Master in-demand skills through structured paths, live mentoring, and project-based learning trusted by engineers at Google, Meta, and Stripe.
              </p>
            </div>
            ...
            <div style={style(0.3)} className="flex flex-wrap gap-3 mb-12">
              <button
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 0 60px rgba(94,234,212,0.35)"; (e.currentTarget as HTMLButtonElement).style.transform = "translateY(-2px)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 0 40px rgba(94,234,212,0.2)"; (e.currentTarget as HTMLButtonElement).style.transform = "none"; }}
              >
            ...
            <div style={style(0.4)} className="flex flex-wrap gap-6">
              {[["2.4M+", "Active learners"], ["94%", "Completion rate"], ["4.9★", "Avg rating"]].map(([v, l]) => (
                <div key={l}>
          ...
          <div style={style(0.25)}>
            <div className="relative rounded-2xl p-6"
              ...
              <div className="flex items-center justify-between mb-5">
                <div>
                  <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, color: "#e2e8f0", fontSize: "0.9rem" }}>My Learning</div>
                  <div style={{ fontFamily: "'DM Mono', monospace", color: "#64748b", fontSize: "0.65rem", marginTop: "2px" }}>Week 24 · Jun 2025</div>
                </div>
              ...
              {[
                { name: "Advanced TypeScript", pct: 78, c: "#5eead4" },
                { name: "PyTorch & Deep Learning", pct: 43, c: "#818cf8" },
                { name: "Figma Design Systems", pct: 91, c: "#c084fc" },
              ].map(c => (
              ...
              <div className="grid grid-cols-3 gap-2 mt-5 pt-4" style={{ borderTop: "1px solid rgba(94,234,212,0.06)" }}>
                {[["128h", "Learned"], ["23d", "Streak"], ["5", "Certs"]].map(([v, l]) => (
            ...
            <div className="absolute -top-4 -right-2 px-3 py-2 rounded-xl flex items-center gap-2"
              ...
              <span style={{ fontFamily: "'DM Mono', monospace", color: "#5eead4", fontSize: "0.7rem" }}>Certificate earned!</span>
            </div>
          </div>
        </div>
      </div>
